...
class DesafioController extends Controller
{
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $desafio->update($request->only([
            'titulo', 'descripcion', 'tipo_desafio', 'duracion_dias',
            'meta_objetivo', 'puntos_recompensa', 'fecha_inicio', 'fecha_fin',
            'dificultad', 'activo', 'imagen_url'
        ]));
    ...
    {
        $desafios = Desafio::with(['usuarioDesafios' => function($query) use ($idUsuario) {
