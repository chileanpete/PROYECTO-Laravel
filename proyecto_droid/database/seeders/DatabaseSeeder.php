...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //$this->call(DesafiosSeeder::class);  //De nico, se uso para pruebas independientes
        //$this->call(TiposEjercicioSeeder::class); //De nico, se uso para pruebas independientes
